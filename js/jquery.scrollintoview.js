...
(function ($)
{
    $.fn.scrollIntoView = function (duration, easing, complete)
    {
        ...
        while (pEl)
        {
            ...
            (pEl.scrollTop != ((pEl.scrollTop -= 1) == null || pEl.scrollTop) && (pEl.scrollTop += 1) != null))
            {
                scrollTo(pEl, elY - 50);//all weibo scroll to top, by leejaen
                //if (elY - 50 <= pY) scrollTo(pEl, elY - 50); // scroll up//Cause class"currwb" boxshadow and topbar, add 10px fix bottom value for weibo.com by leejaen.
                //else if ((elY + elH) + 10 > (pY + pH)) scrollTo(pEl, (elY + elH - pH) + 10); // scroll down//Cause class"currwb" boxshadow, add 10px fix bottom value for weibo.com by leejaen.
